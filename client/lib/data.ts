...
export const staff: StaffMember[] = [
  {
    ...
    email: "anita@jh.gov.in",
    stats: { resolved: 132, avgTimeHours: 28 },
  },
  {
    id: "u2",
    name: "Ravi Kumar",
    role: "DEPT_HEAD",
    departmentId: "roads",
    email: "ravi@jh.gov.in",
    stats: { resolved: 98, avgTimeHours: 42 },
  },
  {
    id: "u3",
    name: "Sunil Das",
    role: "STAFF",
    departmentId: "roads",
    email: "sunil@jh.gov.in",
    stats: { resolved: 61, avgTimeHours: 39 },
  },
  {
    id: "u4",
    name: "Pooja Verma",
    role: "STAFF",
    departmentId: "sanitation",
    email: "pooja@jh.gov.in",
    stats: { resolved: 77, avgTimeHours: 31 },
  },
];
  ...
  },
  {
    ...
    timeline: [
      { at: daysAgo(2), status: "PENDING" },
      {
        at: daysAgo(1),
        status: "CRITICAL",
        note: "Escalated due to smell and animals",
      },
    ],
  },
  {
...
export const notifications: NotificationItem[] = [
  {
    ...
    message: "Garbage overflow in Ashok Nagar",
    createdAt: daysAgo(0),
  },
  {
    id: "n2",
    type: "ASSIGNMENT",
    title: "Task assigned",
    message: "Pothole near Sector 4 to Sunil Das",
    createdAt: daysAgo(1),
  },
  {
    id: "n3",
    ...
    message: "Streetlight issue resolved",
    createdAt: daysAgo(1),
  },
];
